...
const endpoints: EndpointSpec[] = [
  ...
  { controller: DemandesController, methodName: 'statsParStatut', allowedRoles: [Role.DECIDEUR, Role.AGENT_CONEDEF, Role.AUDITEUR, Role.ADMIN_SI], label: 'GET /demandes/stats/par-statut' },
  ...
  // Rapports
  { controller: RapportsController, methodName: 'lister', allowedRoles: [Role.ADMIN_SI, Role.AGENT_MINISTERE, Role.DECIDEUR, Role.AUDITEUR], label: 'GET /rapports' },
  { controller: RapportsController, methodName: 'openData', allowedRoles: [Role.ADMIN_SI, Role.AGENT_MINISTERE, Role.DECIDEUR, Role.AUDITEUR, Role.PUBLIC], label: 'GET /rapports/opendata' },
  { controller: RapportsController, methodName: 'trouverParId', allowedRoles: [Role.ADMIN_SI, Role.AGENT_MINISTERE, Role.DECIDEUR, Role.AUDITEUR], label: 'GET /rapports/:id' },
  ...
  // Conventions
  { controller: ConventionsController, methodName: 'lister', allowedRoles: [Role.CONTRIBUABLE, Role.AGENT_AGENCE, Role.AGENT_MAE, Role.AGENT_DGMG, Role.DECIDEUR, Role.AUDITEUR, Role.ADMIN_SI], label: 'GET /conventions' },
  { controller: ConventionsController, methodName: 'trouverParId', allowedRoles: [Role.CONTRIBUABLE, Role.AGENT_AGENCE, Role.AGENT_MAE, Role.AGENT_DGMG, Role.DECIDEUR, Role.AUDITEUR, Role.ADMIN_SI], label: 'GET /conventions/:id' },
