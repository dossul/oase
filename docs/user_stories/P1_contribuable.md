# OASE — User Stories P1 (contribuable / Opérateur Économique)

> **Issue Plane :** OASE-32
> **Persona :** P1 — Opérateur Économique / contribuable
> **Statut :** Rédigé
...
**En tant que** contribuable, **je veux** me connecter avec mon email institutionnel et mon mot de passe, **afin de** accéder à mon portail d'exonération.
...
**En tant que** contribuable connecté, **je veux** voir mon tableau de bord, **afin de** visualiser d'un coup d'œil l'état de mes demandes.
...
**En tant que** contribuable, **je veux** initier une nouvelle demande d'exonération, **afin de** solliciter un avantage fiscal ou douanier.
...
**En tant que** contribuable, **je veux** consulter le détail d'une demande précise, **afin de** connaître son statut actuel, l'étape en cours et l'historique.
...
**En tant que** contribuable, **je veux** téléverser les pièces justificatives demandées, **afin de** compléter mon dossier.
...
**En tant que** contribuable, **je veux** voir la liste de mes exonérations en cours de validité, **afin de** savoir lesquelles je peux utiliser et quand elles expirent.
...
**En tant que** contribuable, **je veux** être notifié des changements importants sur mes demandes, **afin de** réagir rapidement (compléter un dossier, signer un acte, etc.).
...
**En tant que** contribuable, **je veux** mettre à jour mes informations de profil, **afin de** maintenir mon dossier à jour.
...
**En tant que** contribuable, **je veux** signer électroniquement un acte en saisissant mon PIN, **afin de** valider une étape engageante (engagement de réalisation, acceptation d'attestation).
...
**En tant que** contribuable, **je veux** retrouver rapidement une demande dans mon historique, **afin de** éviter de scroller indéfiniment.
...
**En tant que** contribuable, **je veux** exporter la liste de mes demandes au format Excel, **afin de** la transmettre à mon comptable ou la conserver dans mes archives.
...
**En tant que** contribuable, **je veux** répondre à une demande de complément de l'instructeur, **afin de** débloquer l'instruction de mon dossier.
...
- [ ] Affiche : n° attestation, nom contribuable, type, date émission, date expiration, statut (valide / révoqué / expiré)
...
**En tant que** contribuable, **je veux** me déconnecter de manière sécurisée, **afin de** protéger l'accès à mon compte sur un poste partagé.
...
**En tant que** contribuable, **je veux** accéder à une aide contextuelle, **afin de** comprendre les notions complexes (régimes fiscaux, types de pièces, etc.).
