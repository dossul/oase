...
$items = @(
    ...
    @{ n='[User Stories] Rediger les user stories P1 CONTRIBUABLE'; p='urgent'; d='Rediger les user stories detaillees du CONTRIBUABLE : creation compte, connexion, depot demande, ajout pieces, suivi dossier, reponse complement, consultation exonérations actives, telechargement acte, notifications.' },
    ...
    @{ n='[User Stories] Rediger les user stories P3 agence de promotion'; p='high'; d='Rediger les user stories API-ZF/SAZOF : suivre conventions, agrements, CONTRIBUABLEs, engagements, alertes obligations, consultation dossiers lies et reporting.' },
    ...
    @{ n='[Use Cases] Modeliser les cas d erreur et cas limites'; p='high'; d='Identifier les cas limites : piece manquante, dossier invalide, permission refusee, session expiree, doublon CONTRIBUABLE, montant incoherent, connecteur indisponible, export impossible.' },
    ...
    @{ n='[Tests E2E] Tester parcours CONTRIBUABLE complet'; p='urgent'; d='Tester depot complet d une demande par CONTRIBUABLE : formulaire, upload pieces, brouillon, soumission, suivi statut, notifications, consultation detail et telechargement document.' },
